...
import com.example.neostore.model.InvalidData
            ...
            override fun onResponse(
                ...
                if(response.code() == 500 || response.code()==404 || response.code() == 422){
                    ...
                    try {
                        ...
                        Toast.makeText(this@RegisterActivity, "${error.user_msg}", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(this@RegisterActivity, "$responseData", Toast.LENGTH_SHORT).show()
