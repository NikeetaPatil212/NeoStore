...
import com.example.neostore.model.CartData
import com.example.neostore.R
import com.example.neostore.adapters.CartListAdapter
import com.example.neostore.api.RetrofitClient
import com.example.neostore.model.CartDeleteResponse
import com.example.neostore.model.CartEditResponse
import com.example.neostore.model.CartListResponse
        ...
        RetrofitClient.getClient.editCartItem(accessToken,productId,qty).enqueue(object : Callback<CartEditResponse?> {
            override fun onResponse(
                ...
                if(response.body()!=null){
                    Toast.makeText(this@MyCartActivity,"${response.body()!!.user_msg}",Toast.LENGTH_LONG).show()
                    updateCartData()
                }else
                    Toast.makeText(this@MyCartActivity,"${response.errorBody()}",Toast.LENGTH_SHORT).show()
            }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                Toast.makeText(this@MyCartActivity,"No Data Found",Toast.LENGTH_LONG).show()
                return false
            }
