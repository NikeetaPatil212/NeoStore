...
import com.example.neostore.adapters.OrderListAdapter
import com.example.neostore.api.RetrofitClient
import com.example.neostore.model.OrderListData
import com.example.neostore.model.OrderListResponse
        ...
        RetrofitClient.getClient.orderList(accessToken).enqueue(object : Callback<OrderListResponse?> {
            override fun onResponse(
                ...
                if(response.body() != null){
                    ...
                    OrdersRecyclerView.layoutManager = LinearLayoutManager(this@MyOrdersActivity,
                    ...
                    orderAdapter.onSetClickListerner(object : OrderListAdapter.OnItemClickListerner {
                        ...
                        override fun onClickListerner(position: Number) {
                            val intent = Intent(this@MyOrdersActivity,OrderActivity::class.java)
                    ...
                    Toast.makeText(this@MyOrdersActivity,"${response.errorBody()}",Toast.LENGTH_LONG).show()
                }
            }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                Toast.makeText(this@MyOrdersActivity,"No Data Found",Toast.LENGTH_LONG).show()
                return false
            }
